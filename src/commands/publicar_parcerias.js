...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (cargoRegistrarIds.length === 0 || !canalParceriasId) {
      return await interaction.editReply({
        content: '❌ Configure primeiro em Parcerias: Cargos que Podem Registrar e Canal de Parcerias (`/painel_configuracao`).',
      });
    }
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        ...
        '**Etapa 1:** Preencha o formulário (responsável da outra facção, nome da facção, produto).\n' +
        '**Etapa 2:** Envie o print da parceria (roupa da facção).\n' +
        '**Etapa 3:** Envie o print do mapa (localização da facção).\n\n' +
        `A parceria é publicada automaticamente em <#${canalParceriasId}>.`
      );
